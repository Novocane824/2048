...
(function() {
  $(function() {
    var a1, a2, a3, a4, boardFull, collapseCells, generateTile, getColumn, getRandomCell, getRow, masterArray, mergeCells, ppArray, randomInt, randomValue, x, y, _i, _j;
    ...
    return console.log("final operation: " + mergeCells([2, 0, 2, 4], 'left').DonecollapseCells());
  });
