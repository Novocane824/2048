...
(function() {
  $(function() {
    var WinningTileValue, arrayEqual, boardEqual, boardFull, buildBoard, collapseCells, colorCode, gameLost, gameWon, generateTile, getColumn, getRandomCell, getRow, mergeCells, move, moveIsValid, noValidMoves, ppArray, randomInt, randomValue, setColumn, setRow, showBoard;
    WinningTileValue = 32;
    buildBoard = function() {
